	...
	<div class="container">
		...
		<div class="col-lg-6 col-lg-offset-3">
			<div class="row">
				...
				<form atction='<c:url value="/user?method=resetPassword" />'
					method="post" onsubmit="return checkSubmit('newpswd','newpswd2');">

					<div class="form-group">
						<label for="newpswd">新密码</label> <input class="form-control"
							type="password" name="newpswd" id="newpswd" required="required" />
					</div>
					<div class="form-group">
						<label for="newpswd2">确认新密码</label> <input class="form-control"
							type="password" name="newpswd2" id="newpswd2" required="required" />
					</div>
					<div class="form-group">
						<button class="btn btn-success col-sm-12 col-md-5">更改密码</button>
					</div>
					<div class="form-group">
						<a class="btn btn-primary col-sm-12 col-md-5   col-md-offset-2"
