	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<img src="
					<c:out value="${resume.pic}" default="${path}/resume/images/tm-easy-profile.jpg"/>
...
<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<p>Copyright &copy; 2015.Company name All rights reserved.<a target="_blank" href="<c:url value="/resume/ResumeUpdate" /> ">修改我的简历</a></p>
